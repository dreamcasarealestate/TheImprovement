  ...
  return (
    <div className="relative mt-[60px] mb-[40px]">
      <div className="flex flex-col  gap-[10px]">
        <p className="md:text-[24px] text-[18px] font-Gordita-Bold leading-tight md:leading-[52px] text-center">
          Try our Construction cost estimator
        </p>
        <p className="text-[12px] md:text-[14px] font-Gordita-Regular text-gray-500 md:leading-[16px] md:text-center max-w-[900px] mx-auto">
...
// >
//   <div className="p-4">
//     <h2 className="text-[24px] font-Gordita-Medium mb-4">
//       {job.JobTitle}
//     </h2>
//     {job.ExperienceRange && (
...
//       <>
//         <h3 className="text-[20px] font-Gordita-Medium mb-2">
//           Job Responsibilities
//         </h3>
