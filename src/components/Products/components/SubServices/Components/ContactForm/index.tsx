      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-2">
          <CustomInput
            name="name"
            label="Enter  Name"
            labelCls="font-Gordita-Medium md:text-[14px] text-[12px] text-black"
            type="text"
            value={formData.name}
          ...
          <div className="hidden">
            <SingleSelect
              type="single-select"
              name="services"
              optionCls="text-[12px] font-Gordita-Medium"
        ...
        {showConfirmation && (
          ...
          >
            <div className="flex flex-col items-center justify-center gap-3">
              ...
              <p className="text-[16px] md:text-[16px] font-Gordita-Regular  text-gray-600">
