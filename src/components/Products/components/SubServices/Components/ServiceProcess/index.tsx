...
const ServiceProcess: React.FC<ServiceProcessProps> = ({
  ...
  return (
    ...
    //       {title}
    //     </h1>
    //     <h2 className="font-Gordita-Medium md:text-[20px] text-[18px] text-[#7B7C83] text-center">
    //       {subTitle}
    //     </h2>
    //   </div>
    ...
    //           height={140}
    //         />
    //         <span className="bg-[#0052CC] absolute -top-[14px] right-4 transform -translate-x-[20%] text-white px-4 py-[6px] rounded-[4px] mb-4 text-sm font-Gordita-Medium">
    //           {step.step}
    //         </span>
    //         <h3 className="font-Gordita-Bold text-[20px] text-center mb-2">
    //           {step.title}
    //         </h3>
    //         <p className="font-Gordita-Regular text-center text-[#7B7C83]">
    //           {step.description}
    //         </p>
    //       </div>
    //     ))}
    ...
    //             height={140}
    //           />
    //           <span className="bg-[#0052CC] absolute -top-[11px] right-4 transform -translate-x-[20%] text-white px-4 py-[6px] rounded-[4px] mb-12 text-sm font-Gordita-Medium">
    //             {step.step}
    //           </span>
    //           <h3 className="font-Gordita-Bold md:text-[20px] text-[16px] text-center mb-2">
    //             {step.title}
    //           </h3>
    //           <p className="font-Gordita-Regular text-center md:text-[16px] text-[12px] text-[#7B7C83]">
    //             {step.description}
    //           </p>
    //         </div>
    //       ))}
        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="relative bg-white/90 border border-gray-200/60 p-6 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 group-hover:border-[#3586FF]/40 group-hover:translate-y-[-6px] flex flex-col items-center text-center backdrop-blur-sm">
              ...
              <h3 className="font-Gordita-Bold text-[20px] text-gray-900 mb-2 group-hover:text-[#0052CC] transition-colors duration-300">
                {step.title}
              </h3>
              <p className="font-Gordita-Regular text-[15px] text-[#6B7280] leading-relaxed">
                {step.description}
              </p>
            </div>
          </motion.div>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="relative bg-white/90 border border-gray-200 rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 flex flex-col items-center text-center p-3 backdrop-blur-sm">
                ...
                <h3 className="font-Gordita-Bold text-[16px] text-gray-900 mb-2">
                  {step.title}
                </h3>
                <p className="font-Gordita-Regular text-[12px] text-[#6B7280] leading-relaxed">
                  {step.description}
                </p>
              </div>
            </motion.div>
