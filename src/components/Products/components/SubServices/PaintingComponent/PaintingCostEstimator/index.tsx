            ...
            >
              ...
              <div className="flex flex-col justify-between md:items-center">
                ...
                <div className="relative group cursor-pointer md:mt-2 mt-0 flex items-end justify-end">
                  ...
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-40 bg-gray-800 text-white text-[10px] rounded px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity font-Gordita-Regular">
                    {option.tooltip}
                  </div>
                </div>
              </div>
        ...
        : "hover:shadow-md hover:scale-[1.01] focus:ring-2 focus:ring-gray-300"
            ...
            >
              ...
              <div className="flex items-start flex-col gap-2">
                <h3 className="font-Gordita-Bold md:text-[16px] text-[12px] text-white">
                  {pkg.name}
                </h3>
                <p className="md:text-[14px] font-Gordita-Medium text-[10px] text-white">
                  {pkg.desc}
                </p>
              </div>
                  ...
                  <ul className="md:space-y-3 space-y-1 flex items-start flex-col ">
                    {pkg.options.map((opt) => (
                      ...
                      >
                        ...
                        <span className="text-[10px] font-Gordita-Regular md:text-[12px] text-gray-700">
                          {opt.label}
                        </span>
                      </li>
                    ))}
  ...
  const renderStep3 = () => (
    <div className="flex flex-col items-center md:gap-4 gap-2 md:max-w-full max-w-[300px] ">
      <div className="md:space-y-3 space-y-1 ">
        <p className="font-Gordita-Bold text-center md:text-[16px] text-[14px]">
          GET YOUR ESTIMATE ON WHATSAPP
        </p>
        <p className="md:text-[14px] text-[12px] text-center font-Gordita-Medium text-gray-500">
      ...
      >
        <CustomInput
          ...
          type="text"
          name="Fullname"
          labelCls="font-Gordita-Medium label-text text-black"
        ...
        <div className="flex flex-col md:gap-y-[8px] gap-y-[4px] w-full">
          <p className="font-Gordita-Medium text-gray-700 md:text-[14px] text-[12px]">
        ...
        return (
          <div className="flex flex-col items-center justify-center w-full text-center space-y-3 md:space-y-6">
            ...
            <div className="space-y-3">
              <h1 className="text-[14px] md:text-[18px] lg:text-[26px] font-Gordita-Bold text-white leading-tight tracking-tight">
                Smart Painting{" "}
            ...
            <div className="md:space-y-4 space-y-2">
              <p className="text-gray-100 text-[12px] md:text-[16px] font-Gordita-Medium max-w-md leading-relaxed bg-white/10 backdrop-blur-sm md:p-4 p-2 md:rounded-[12px] rounded-[6px] border border-white/20">
                Discover your{" "}
                <span className="text-yellow-300 font-Gordita-Bold">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  ...
                  >
                    ...
                    <span className="text-gray-200 text-[10px] md:text-[12px] font-Gordita-Medium">
                      {feature}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-sm p-1.5 md:p-3 rounded-2xl border border-yellow-400/30">
              <p className="text-[10px] md:text-[12px] font-Gordita-Regular text-yellow-200 italic">
      ...
      case 2:
        return (
          <div className="flex flex-col items-center justify-center w-full text-center space-y-3 md:space-y-6 md:px-4 px-2">
            ...
            <div>
              <h1 className="text-[q8px] md:text-[26px] font-Gordita-Bold text-white leading-tight tracking-wide">
                Choose Your{" "}
            ...
            <p className="text-gray-200 text-[12px] font-Gordita-Medium md:text-[16px] max-w-lg leading-relaxed">
              Select from our curated{" "}
              <span className="text-yellow-400 font-Gordita-Regular">
                Economy
              </span>
              ,{" "}
              <span className="text-yellow-400 font-Gordita-Regular">
            ...
            <p className="text-[10px] md:text-[12px] font-Gordita-Regular text-gray-400 italic">
      ...
      case 3:
        return (
          <div className="flex flex-col items-center justify-center w-full text-center space-y-3 md:space-y-6 md:px-4 px-2">
            ...
            <div>
              <h1 className="text-[18px] md:text-[26px] font-Gordita-Bold text-white leading-tight tracking-wide">
                Share Your{" "}
                <span className="bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent drop-shadow-md">
                  Details
                </span>
  ...
  const renderEstimator = () => (
    <div className="bg-gradient-to-br from-white to-blue-50 md:rounded-[16px] rounded-[6px] shadow-2xl border border-blue-100 max-w-[900px] w-full mx-auto p-4 md:p-8 text-center transition-all duration-300 hover:shadow-3xl">
      ...
      <div className="border-t border-gray-200 md:pt-6 pt-3">
        <p className="text-gray-600 font-Gordita-Medium md:text-[16px] text-[12px] mb-1 flex items-center justify-center gap-1">
          <IndianRupee className="w-4 h-4 text-green-600" />
          Estimated Total Cost
        </p>

        <p className="text-green-600 font-Gordita-Bold text-[32px] md:text-[42px] tracking-wide drop-shadow-sm">
              ...
              <div className="flex justify-between mt-6">
                {currentStep > 1 && (
                  <Button
                    ...
                    className="flex items-center gap-2 md:px-6 px-3 md:py-2 py-1.5 md:text-[16px] text-[12px] font-Gordita-Medium bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300"
                  >
