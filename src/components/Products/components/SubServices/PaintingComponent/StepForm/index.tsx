  ...
  if (isSubmitted) {
    ...
    return (
      <div className="rounded-[10px] shadow-custom-card bg-white min-h-[inherit] h-full md:p-6 p-4 flex flex-col items-center justify-center text-center md:space-y-4 space-y-2 animate-fade-in">
        ...
        <p className="font-Gordita-Regular text-gray-600 label-text max-w-[300px] animate-fade-in-delayed">
        ...
        >
          {step === 1 ? (
            <>
              ...
              <p className="font-Gordita-Medium text-gray-600 label-text ">
          ...
          <div className="flex flex-col gap-2  md:px-1 md:py-0.5 px-2 py-1 rounded-md">
            ...
            <div className="flex md:flex-row flex-col items-center gap-2">
              ...
              <div className="flex flex-col md:gap-y-[8px] gap-y-[4px] w-full md:max-w-[540px] max-w-[280px] mb-1">
                <p className="font-Gordita-Medium label-text text-black">
                  City
                </p>
                <SingleSelect
                  type="single-select"
            ...
            <div className="flex gap-2 w-full justify-between mt-1  md:mt-3 items-center">
              <Button
                type="button"
                onClick={() => setStep(1)}
                className="bg-gray-500 text-white md:px-6 px-3 md:rounded-[10px] rounded-[4px] font-Gordita-Medium md:text-[16px] text-[12px] md:py-2 py-2"
              >
                Back
              </Button>
              <Button
