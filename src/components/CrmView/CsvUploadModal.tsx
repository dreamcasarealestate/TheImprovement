  ...
  return (
    ...
    >
      {isLoading ? (
        <div className="p-8">
          <Loader />
          <p className="text-center mt-4 font-Gordita-Medium text-gray-600">
            Uploading leads...
          </p>
        </div>
      ) : (
        <div className="relative flex flex-col items-center w-full p-6">
          ...
          <div className="w-full mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-[12px] font-Gordita-Bold text-blue-900 mb-2">
              Required CSV Columns:
            </p>
            <div className="grid grid-cols-2 gap-2 text-[11px] font-Gordita-Medium text-blue-800">
          ...
          <div className="w-full mb-6">
            ...
            >
              <div className="w-full px-6 py-8 border-2 border-dashed border-gray-300 hover:border-blue-400 rounded-lg text-center transition-colors bg-gray-50 hover:bg-blue-50">
                ...
                {selectedFile ? (
                  <div>
                    <p className="text-[14px] font-Gordita-Bold text-gray-800 mb-1">
                      {selectedFile.name}
                    </p>
                    <p className="text-[12px] text-gray-600 font-Gordita-Medium">
                  ...
                  <div>
                    <p className="text-[14px] font-Gordita-Bold text-gray-700 mb-1">
                      Choose CSV file or drag here
                    </p>
                    <p className="text-[12px] text-gray-500 font-Gordita-Medium">
          ...
          <div className="w-full mb-6 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-[11px] font-Gordita-Bold text-yellow-900 mb-1">
              ⚠️ Important Notes:
            </p>
            <ul className="text-[10px] font-Gordita-Medium text-yellow-800 space-y-1">
          ...
          <div className="w-full flex gap-3">
            <Button
              onClick={handleClose}
              className="flex-1 py-3 px-4 border-2 border-gray-300 rounded-lg text-[14px] font-Gordita-Medium text-gray-700 hover:bg-gray-50 transition-colors"
            >
              Cancel
            </Button>
            <Button
