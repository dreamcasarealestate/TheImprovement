    ...
    <div className="relative">
      ...
      >
        ...
        {totalNotifications > 0 && (
          <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-Gordita-Bold rounded-full w-5 h-5 flex items-center justify-center">
          ...
          <div className="absolute right-0 mt-2 w-80 md:w-96 bg-white rounded-lg shadow-2xl z-50 max-h-[500px] overflow-hidden flex flex-col">
            ...
            <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
              <div className="flex items-center justify-between">
                <h3 className="text-[16px] font-Gordita-Bold text-gray-800">
                  Follow-up Reminders
                </h3>
                <Button
                  onClick={() => setIsOpen(false)}
                  ...
                  {overdueFollowUps.length > 0 && (
                    <div className="border-b border-gray-200">
                      <div className="bg-red-50 px-4 py-2 flex items-center gap-2">
                        ...
                        <h4 className="text-[13px] font-Gordita-Bold text-red-700">
                  ...
                  {todayFollowUps.length > 0 && (
                    <div className="border-b border-gray-200">
                      <div className="bg-yellow-50 px-4 py-2 flex items-center gap-2">
                        ...
                        <h4 className="text-[13px] font-Gordita-Bold text-yellow-700">
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[13px] font-Gordita-Bold text-gray-800 truncate">
            {lead.Fullname}
          </p>
