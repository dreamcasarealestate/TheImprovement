  ...
  return (
    <div className="relative w-full">
      <Button
        ...
        className="flex items-center text-gray-600 gap-2 bg-white border font-Gordita-Medium border-gray-300 md:text-[12px] text-[10px] text-nowrap md:py-[6px] py-[4px] md:px-4 px-2 rounded-lg hover:bg-gray-50 transition-colors"
      >
        <FaEye />
        Saved Views
      </Button>
        ...
        <>
          ...
          <div className="absolute top-full right-0 w-[500px] md:max-w-[220px] max-w-[280px] mt-2 bg-white border border-gray-200 shadow-2xl rounded-lg z-50 overflow-hidden">
            ...
            <div className="p-3 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
              <h3 className="text-[14px] font-Gordita-Bold text-gray-800">
                Saved Filter Views
              </h3>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="flex-1 bg-gray-200 text-gray-700 px-2 py-1.5 rounded-md text-[11px] font-Gordita-Medium hover:bg-gray-300 transition-colors"
                    >
                      Cancel
                    </Button>
                  </div>
            ...
            {savedViews.length > 0 && (
              <div className="p-2 border-t border-gray-200 bg-gray-50">
                <p className="text-[10px] text-gray-500 text-center font-Gordita-Medium">
