        ...
        <div id={id} className="mb-6 scroll-mt-24">
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="md:text-[18px]  font-Gordita-Bold text-black text-left">
                        {title}
                    </h2>
                </div>
            ...
            >
                ...
                <ul className="space-y-2">
                    {items.map((item, idx) => (
                        <li
                            key={idx}
                            className="text-slate-700 font-Gordita-Medium text-sm flex items-start gap-2"
                        >
            ...
            <div className="bg-gradient-to-r from-gray-300 via-gray-500 to-gray-700 text-white">
                <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h1 className="text-4xl md:text-6xl font-Gordita-Bold mb-2">
                                Privacy Policy
                            </h1>
                    ...
                    <div className="flex flex-wrap gap-3 mt-6">
                        <div className="px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm font-Gordita-Medium">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    <div className="flex gap-2 overflow-x-auto py-4 no-scrollbar">
                        ...
                        <Button
                            ...
                            className={`px-6 py-3 rounded-lg font-Gordita-Bold text-sm whitespace-nowrap transition-all duration-300 flex items-center gap-2 ${activeTab === "interiors"
                        ...
                        <Button
                            ...
                            className={`px-6 py-3 rounded-lg font-Gordita-Bold text-sm whitespace-nowrap transition-all duration-300 flex items-center gap-2 ${activeTab === "construction"
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 bg-white rounded-2xl shadow-md p-6 border border-slate-100">
                            ...
                            <div className="mt-6 p-4 bg-gradient-to-br from-blue-50 to-green-50 rounded-lg border border-blue-100">
                                <p className="text-xs text-slate-600 font-Gordita-Medium mb-2">
                                    Have questions?
                                </p>
                                <Button
                    ...
                    <div className="lg:col-span-3">
                            ...
                            <div className="prose max-w-none">
                                ...
                                <div className="grid md:grid-cols-3 gap-4 mt-6">
                                    ...
                                    <div className="text-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                                        ...
                                        <h4 className="font-Gordita-Bold text-slate-800">Interiors</h4>
                                        <p className="text-sm text-slate-600 font-Gordita-Medium mt-1">
                                            Design &amp; Furnishing
                                        </p>
                                    </div>
                                    <div className="text-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                                        ...
                                        <h4 className="font-Gordita-Bold text-slate-800">Construction</h4>
                                        <p className="text-sm text-slate-600 font-Gordita-Medium mt-1">
                                            Build &amp; Renovate
                                        </p>
                                    </div>
                                </div>
                                <p className="text-slate-700 leading-relaxed font-Gordita-Medium mt-6">
                        ...
                        >
                            <div className="space-y-6">
                                <p className="text-slate-700 leading-relaxed font-Gordita-Medium">
                        ...
                        >
                            <div className="space-y-4">
                                <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-4">
                                    <p className="font-Gordita-Bold text-yellow-900 mb-2 flex items-center gap-2">
                                        <MdLock />
                                        We Do Not Sell Your Personal Data
                                    </p>
                                    <p className="text-slate-700 font-Gordita-Medium text-sm">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        >
                                            ...
                                            <div>
                                                <h4 className="font-Gordita-Bold text-slate-800">{item.title}</h4>
                                                <p className="text-sm text-slate-600 font-Gordita-Medium mt-1">
                                                    {item.desc}
                                                </p>
                                            </div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        {[
                                            ...
                                            <div key={idx} className="bg-white rounded-lg p-4 shadow-sm">
                                                ...
                                                <h4 className="font-Gordita-Bold text-slate-800 text-sm">
                                                    {item.title}
                                                </h4>
                                                <p className="text-xs text-slate-600 font-Gordita-Medium mt-1">
                                                    {item.desc}
                                                </p>
                                            </div>
                                        ))}
                                ...
                                <div className="grid gap-3">
                                    {[
                                        ...
                                        return (
                                            ...
                                            >
                                                <div>
                                                    <h4 className="font-Gordita-Bold text-slate-800">
                                                        {item.desc}
                                                    </h4>
                                                </div>
                                                <div className={`px-4 py-2 rounded-full text-xs font-Gordita-Bold ${map.badge}`}>
                                                    {item.period}
                                                </div>
                                            </div>
                                        );
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    {[
                                        ...
                                        >
                                            ...
                                            <h4 className="font-Gordita-Bold text-slate-800 mb-2">
                                                {item.title}
                                            </h4>
                                            <p className="text-sm text-slate-600 font-Gordita-Medium">
                                                {item.desc}
                                            </p>
                                        </div>
                                    ))}
                                            ...
                                            >
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {item.required && (
                                                            <span className="px-2 py-0.5 bg-yellow-100 text-yellow-800 text-xs font-Gordita-Bold rounded-full">
                                                                Required
                                                            </span>
                                                        )}
                                                    </div>
                        ...
                        >
                            <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
                                <p className="text-slate-700 font-Gordita-Medium leading-relaxed">
                        ...
                        >
                            <div className="bg-yellow-50 rounded-lg p-6 border-l-4 border-yellow-500">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-Gordita-Bold text-slate-800 text-lg mb-3">
                                            Age Requirement: 18+
                                        </h3>
                                        <p className="text-slate-700 font-Gordita-Medium mb-3">
                        ...
                        >
                            <div className="space-y-6">
                                <p className="text-slate-700 font-Gordita-Medium text-lg">
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    ...
                                    >
                                        <div className="flex flex-col items-center text-center">
                                            ...
                                            <h4 className="font-Gordita-Bold text-slate-800 mb-2">Call Us</h4>
                                            <p className="text-sm text-green-700 font-Gordita-Bold">
                                                +91 86398 20425
                                            </p>
                                        </div>
                                    </a>
                        ...
                        <div className="bg-gradient-to-r from-blue-400 via-blue-500  rounded-2xl p-8 text-white shadow-xl mt-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm label-text font-Gordita-Medium">
